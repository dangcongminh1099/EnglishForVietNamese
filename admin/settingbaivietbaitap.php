<body <?php if (isset($_GET["option"]) && $_GET["option"] == 6) echo "onload='hientiny()'" ?>>
    ...
    ?>
        <div id="themcauhoi">
                    ...
                    <form action="themcauhoi(new).php" id="formthemcauhoi" method="POST" enctype="multipart/form-data">
                        ...
                        <table cellspacing="0" cellpadding="10">
                            ...
                            <tr style="padding:30px">
                                <th colspan="3"><button type="submit" name="action" value="Thêm" onclick="return validateThemCauHoi(<?php if ($laymadanhmuc[0] == 2 || $laymadanhmuc[0] == 4) echo '0';
                                                                                                                                    else echo '1'; ?> )">Thêm câu hỏi</button></th>
                            </tr>
                                        ...
                                        <ul>
                                            ...
                                            <li class="colli">
                                                <i class="fa fa-play-circle" onclick="playaudios(<?php echo $count; ?>,'audiocauhoi')" style="<?php if ($laymadanhmuc[0] == 2 || $laymadanhmuc[0] == 4) echo "color:green";
                                                                                                                                                ...
                                                                                                                                                ?>"></i>
                                                <audio class="audiocauhoi" src="../<?php if ($layttch[3] == "") echo "";
                                                                                    else echo $layttch[3]; ?>"></audio>
                                            </li>
                                            <li class="colli"><a href="suacauhoi.php?action=xoa&macau=<?php echo $layttch[0]; ?>&mabt=<?php echo $mabt ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa')"><button class="buttonxoacau" type="button">Xóa</button></a></li>
                ...
                ?>
                    ...
                    <form action="chinhsuacauhoi,phuongan.php" id="formthemcauhoi" method="POST" enctype="multipart/form-data">
                        ...
                        <table cellspacing="0" cellpadding="10">
                            <tr>
                                <th colspan="3">
                                    <h2>Sửa câu hỏi và phương án</h2>
                                </th>
            ...
            <tr style="padding:30px">
                <th colspan="3"><button type="submit" name="action" value="chinhsua" onclick="return validatesuacauhoi(<?php if ($laymadanhmuc[0] == 2 || $laymadanhmuc[0] == 4) echo '0';
                                                                                                                        else echo '1'; ?>)">Chỉnh sửa câu hỏi</button></th>
            </tr>
            ...
            ?>
                <tr>
                    ...
                    ?>
                        ...
                        if ($x == count($arr[$i]) - 1) {
                        ?>
                            <th><a href="?page=3&mabt=<?php echo $arr[$i][0]; ?>&option=1&trang=<?php if (isset($_GET["trang"])) echo $_GET["trang"];
                                                                                                else echo "0" ?>"><button type="button">Câu hỏi, đáp án</button></a></th>

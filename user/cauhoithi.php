...
?>
    ...
    ?>
        ...
        <body onload="setTimeStart(0)">
            ...
            <div id="baitest">
                <div id="tieude">
                    <h2 id="tieudebaitap"><?php echo $a[2];
                                            if ($type == 1) echo ". Hãy chọn đáp án đúng";
                                            else echo ". Ghép nối câu chính xác" ?></h2>
                </div>
                <br>
                <div id="noidungch">
                    <?php
        ...
        <div id="tool">
            ...
            <span style="line-height:12px;">Page <?php echo $trang + 1 ?> of <?php if ($tongsotrang == 0 || $tongsotrang == 1) echo 1;
                                                                            else echo $tongsotrang; ?></span>
            <div id="dieuhuongtrang">
                <a href="?option=4&baitap=<?php echo $mabaitap ?>&trang=<?php echo ($trang + 1) ?>"><button <?php if ($trang == $tongsotrang || $tongsotrang == 1) {
                                                                                                            echo "disabled ";
                                                                                                            echo "style='background-color:#102b3e;color:red'";
                                                                                                        } ?>>
                        <i class="fa fa-arrow-right" <?php if ($trang == $tongsotrang || $tongsotrang == 1) echo "style='color:#6d6d6d' " ?>></i>

                    </button></a>
                <a href="?option=4&baitap=<?php echo $mabaitap ?>&trang=<?php echo ($trang - 1) ?>"><button <?php if ($trang == 0) {
                                                                                                            echo "disabled ";
                                                                                                            echo "style='background-color:#102b3e;color:red'";
                                                                                                        } ?>>
        ...
        <script>
            ...
            function kiemtraphuongan(x) {
                if (x == 1) {
                    var name = "cau",
                        kt = 1,
                        repport_err, repport_success, classs = "phuongan";
